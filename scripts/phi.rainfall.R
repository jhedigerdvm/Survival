...
#model looking at rainfall, site, and age, no random effects
# Specify model in JAGS language
set.seed(100)
...
parameters <- c('int', 'site.beta', 'rain.beta', 'age.beta', 'rain.site.beta', 'p','survival_diff_rain1','survival_diff_rain500','survival_diff_rain1000')#survival
...
write.csv(cjs.rain.site.age$summary, './output/rain.site.age.summary.csv')
...
ggsave('./figures/phi_rain_site_age1.jpg', phi.plot.1, width = 15, height = 15)
...
# write.csv(cjs.rain.site.ran.age$summary, './output/summary.rainsite.randomage.csv')
...
ggsave('./figures/phi_rain_site_ran_age.jpg', phi.plot.ran.age, width = 15, height = 15)
