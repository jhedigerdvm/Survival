...
# 
# 
# parameters <- c('int', 'beta1', 'beta2', 'beta3',"beta4",'beta5','phi.age', "phi.site.diff", 'phi.age.diff')
# 
# # MCMC settings
# ni <- 5000
# nt <- 10
