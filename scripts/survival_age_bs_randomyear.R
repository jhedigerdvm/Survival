...
known.fate <- known.fate[, -c(1,19,18)]
...
# 
# #make a matrix marking the true first capture occasion, 
# f.matrix<-data
# for (i in 1:dim(f.matrix)[1]){
#   f.matrix[i,2] <- 2007 - data$birth_year[i]  +2
#   f.matrix[i,3] <- 2007 - data$birth_year[i]  +3
#   f.matrix[i,4] <- 2007 - data$birth_year[i]  +4
#   f.matrix[i,5] <- 2007 - data$birth_year[i]  +5
#   f.matrix[i,6] <- 2007 - data$birth_year[i] +6
#   f.matrix[i,7] <- 2007 - data$birth_year[i] +7
#   f.matrix[i,8] <- 2007 - data$birth_year[i] +8
#   f.matrix[i,9] <- 2007 - data$birth_year[i] +9
#   f.matrix[i,10] <- 2007 - data$birth_year[i] +10
#   f.matrix[i,11] <- 2007 - data$birth_year[i] +11
#   f.matrix[i,12] <- 2007 - data$birth_year[i] +12
#   f.matrix[i,13] <- 2007 - data$birth_year[i] +13
#   f.matrix[i,14] <- 2007 - data$birth_year[i] +14
#   f.matrix[i,15] <- 2007 - data$birth_year[i] +15
#   f.matrix[i,16] <- 2007 - data$birth_year[i] +16}
# 
# f.matrix<- f.matrix[,-c(1,17, 18)]
# f.matrix[f.matrix<=0] <- NA
...
for (u in 1:15){     #15 age classes but 14 survival periods                        
...
# 
# 
# for(capyear in 1:15){                               ##ERROR WITH DIMENSION MISMATCH
